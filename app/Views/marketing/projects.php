<div id="projects">
	<div class="row title_div">
		...
		<div class="col-md-6">
			<h3 class="text-center">Проекти на прорахунок</h3>
		</div>
	...
	<div class="row">
				...
				<?php if (!empty($projects)): ?>
					<?php foreach ($projects as $project): ?>
						<tr data-project_id="<?= $project['id']; ?>">
							...
							<td data-label="Дата завершення"><?= $project['end_date'] > 0 ? date("d.m.Y", $project['end_date']) : ''; ?></td>
							<td data-label="Коментар"><?= $project['comment']; ?></td>
							<td data-label="Документи"></td>
							<!--							<td>-->
		...
		<!--						<tr data-project_id="--><? //= $project['id']; ?><!--">-->
		<!--							<td><input class="project_checkbox" type="checkbox"></td>-->
		<!--							<td>--><? //= $project['id']; ?><!--</td>-->
		<!--							<td>--><? //= $project['name']; ?><!--</td>-->
		...
		<!--							<td>-->
		<? //= $project['end_date'] > 0 ? date("d.m.Y", $project['end_date']) : ''; ?><!--</td>-->
		...
		<!--							</td>-->
		<!--							<td>-->
		<!--								<a href="/plan_fact/project/-->
		<? //= $project['id']; ?><!--" class="project_plan_fact"-->
		<!--								   data-title="План факт">-->
		<!--																		План факти-->
		<!--									<img src="../../../icons/bootstrap/square-half.svg"/>-->
		<!--								</a>-->
		<!--							</td>-->
		<!--						</tr>-->
		<!--					--><?php //endforeach; ?>
