...
<head>
	...
	<link href="<?=$base_url; ?>/css/inspinia/bootstrap.min.css" rel="stylesheet">
	<link href="<?=$base_url; ?>/css/inspinia/font-awesome.css" rel="stylesheet">

	<link href="<?=$base_url; ?>/css/inspinia/plugins/dataTables/datatables.min.css" rel="stylesheet">

	<link href="<?=$base_url; ?>/css/inspinia/animate.css" rel="stylesheet">
	<link href="<?=$base_url; ?>/css/inspinia/style.css" rel="stylesheet">
			...
			<ul class="nav metismenu" id="side-menu">
				<li class="nav-header">
					<div class="dropdown profile-element">
						<img alt="image"  src="<?= $base_url; ?>/img/logo-min.png"/>
